...
def get_categories():
    r = requests.get('http://172.26.0.1:3000/get_category_list')
...
def get_idea(category, category_ids):
    ...
    r = requests.get('http://172.26.0.1:3000/get_idea', json=pload)
...
def post_idea(category, category_ids, idea):
    ...
    r = requests.post('http://172.26.0.1:3000/add_idea', json=pload)
    return r
