...
def get_categories():
    r = requests.get('http://157.245.154.156/get_category_list')
...
def get_idea(category, category_ids):
    ...
    r = requests.get('http://157.245.154.156/get_idea', json=pload)
...
def post_idea(category, category_ids, idea):
    ...
    r = requests.post('http://157.245.154.156/add_idea', json=pload)
    return r
